...
const quickjs_c = loadFile("src/quickjs.c")
...
const gen_builtin_array_fromasync_h = loadFile("src/builtin-array-fromasync.h")
const gen_builtin_iterator_zip_h = loadFile("src/builtin-iterator-zip.h")
const gen_builtin_iterator_zip_keyed_h = loadFile("src/builtin-iterator-zip-keyed.h")
